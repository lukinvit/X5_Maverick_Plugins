...
> **Обновление 2026-06-17 (релокация в бандл).** По решению владельца репо `Plugins/` ведётся как монорепо под много плагинов, каждый — в своём каталоге. Вся операционка и плагин уложены в самодостаточный бандл `Plugins/X5Tracker/`: `X5Tracker/docs/`, `X5Tracker/Product_agents/`, `X5Tracker/.claude/agents/`, и сам плагин в корне `X5Tracker/`. Дерево ниже — исходный план (root-relative); фактически каждый его путь имеет префикс `X5Tracker/`. Платформенный spec остаётся общим reference на месте.

Доки операционной системы — в бандле `Plugins/X5Tracker/` (см. примечание выше); сам плагин — в корне `Plugins/X5Tracker/`.
